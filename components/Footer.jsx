    ...
    <footer className="bg-dark text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Tecnología láser avanzada y tratamientos de belleza premium en Rosario.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3 text-gray-400">
              <a 
                href="https://www.google.com/maps/search/Alvear+388+Rosario+Santa+Fe" 
                target="_blank" 
                rel="noopener noreferrer"
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} SkinLaser & Beauty. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  )
